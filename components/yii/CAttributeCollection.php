<?php
namespace panix\mod\shop\components\yii;
class CAttributeCollection extends CMap
{
	...
	{
		return $this->contains($name) || parent::hasProperty($name, $checkVars = true, $checkBehaviors = true);
	}
	/**
	...
	{
		return $this->contains($name) || parent::canGetProperty($name, $checkVars = true, $checkBehaviors = true);
	}
	/**
	...
	{
		return parent::canGetProperty($name, $checkVars = true, $checkBehaviors = true); //PANIX return ture of old
	}
	/**
