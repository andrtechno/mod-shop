        ...
        success: function (response) {
            ...
            $.each(response.filters, function (name, filter) {
                ...
                $.each(filter.filters, function (index, data) {
                    ...
                    if (data.count) {
                        $('#filter-' + filter.key + '-' + data.id + ':not(:checked)').attr('disabled', false);
                        $('#filter-' + filter.key + '-' + data.id).removeClass('disabled');
                        // $('#filter-' + name + ' #li-' + data.id).show();
                        hideCounter++;
                    } else {
                        $('#filter-' + filter.key + '-' + data.id + ':not(:checked)').attr('disabled', 'disabled');
                        $('#filter-' + filter.key + '-' + data.id).addClass('disabled');
