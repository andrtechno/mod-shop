...
use panix\mod\shop\models\ProductReviews as BaseProductReviews;
use yii\helpers\Url;
use Yii;
 ...
 *
 *
 * GET /api/shop/product?token={token} Список товаров
 * GET,PUT,DELETE /api/shop/product/{id}?token={token} Товар
 *
 * $_GET params "&expand=characteristics,<etc>"
 * $_GET params "&field=id,<etc>"
 */
class ProductReviews extends BaseProductReviews
{
