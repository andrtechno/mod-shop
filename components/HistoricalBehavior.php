...
class HistoricalBehavior extends Behavior {
    ...
    public function attach($owner) {
        ...
        $owner->on('onProductAdded', [$this, 'productAddedEvent']);
        $owner->on('onProductDeleted', [$this, 'productDeletedEvent']);
        $owner->on('onProductQuantityChanged', [$this, 'productQuantityChanged']);
        $owner->on('onOrderStatusChanged', [$this, 'orderStatusChanged']);
